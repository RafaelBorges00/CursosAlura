...
public class ConsultaControllerTest {
    ...
    @Autowired
    private MockMvc mvc;
    /* Simula JSON de entrada */
    @Autowired
    private JacksonTester<DadosAgendamentoConsulta> dadosJson;
    /* Simula JSON de saída */
    @Autowired
    private JacksonTester<DadosDetalhamentoConsulta> dadosRetJson;
    /* Para quando o Spring Chamar essa classe ele não usar o banco de dados real através do autowired nela contido */
    @MockBean
    private AgendaDeConsultas agendaDeConsultas;

    @Test
    @DisplayName("Deveria devolver codigo HTTP 400 quando informações estão inválidas !")
    @WithMockUser /* Considere que estou logado */
    ...
    void agendarCenario2() throws Exception {
        ...
        var jsonEsperado = dadosRetJson.write(
